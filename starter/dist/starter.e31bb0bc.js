...
var elementOld = _react.default.createElement('div', null, 'React element!'); // This line is a more verbose way of making an object


var element = /*#__PURE__*/_react.default.createElement("div", null, "React element with JSX!"); // This must be transformed, use npm init to binitialize js project. use npm i 'package' to install a package
// Also, the React auto-comes from the imports in HTML


_reactDom.default.render(element, document.getElementById('root')); // Renders an element, and document is a very powerful object. But it is bad because document.body direct accessing is dangerous. So, getElementById is used.
